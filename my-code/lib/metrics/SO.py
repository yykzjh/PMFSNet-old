...
class SurfaceOverlappingValues(object):
    def __init__(self, num_classes=33, c=6, theta=1.0, sigmoid_normalization=False):
        """
        定义表面重叠数值(SO)评价指标计算器
    ...
    def __call__(self, input, target):
        ...
        return compute_per_channel_so(seg, target, self.num_classes, c=self.c, theta=self.theta)
