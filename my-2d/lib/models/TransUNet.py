...
from lib.models.modules.vit import ViT



class TransUNet(nn.Module):
    def __init__(self, img_dim=512, in_channels=3, out_channels=128, head_num=4, mlp_dim=512, block_num=8, patch_dim=16, class_num=1):
        super().__init__()
