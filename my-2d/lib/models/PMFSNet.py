...
class PMFSNet(nn.Module):
    def __init__(self, in_channels=1, out_channels=35,
        ...
        self.up2 = torch.nn.Upsample(scale_factor=2, mode='bilinear')
        ...
        self.out_linear = nn.Linear(downsample_channels[0] * 7 * 7, out_channels)
...
if __name__ == '__main__':
    ...
    model = PMFSNet(in_channels=3, out_channels=2).to(device)
